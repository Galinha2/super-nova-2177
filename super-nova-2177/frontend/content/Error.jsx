  ...
  return (
    <>
      {visibleMessages.map((message, index) => (
        <div
          key={index}
          className="fixed bottom-10 right-10 w-auto h-auto px-5 py-2 bg-red-500 rounded-[20px] flex items-center justify-center text-white text-[0.7em] font-[900] mb-2"
